...
sub _create_type_custom;
sub create_type_array;
sub create_type_basic;
sub create_type_closure;
sub create_type_object;
sub create_type_pointer;
sub create_type_record;
sub create_type_string;
}
package FFI::Raw {
sub DESTROY;
sub call;
